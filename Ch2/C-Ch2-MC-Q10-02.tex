...
%
%Begin Question---------------------------------
Which of the following compounds do you expect to possess the largest percent ionicity? You are provided with a periodic table with relevant information on the last page of the quiz. Atomic numbers are provided in parentheses, below.
...
\begin{FileID}
	\begin{center}
		\begin{tabular}{ll}
			...
			\hline
			\#AssignmentTag: QuiD2 & \#TermTag: F16 \\ %add
			\hline
